...
#define POWER_RESETREAS_RESETPIN_DETECTED   POWER_RESETREAS_RESETPIN_Detected
#define POWER_RESETREAS_DOG_DETECTED        POWER_RESETREAS_DOG_Detected
#define POWER_RESETREAS_SREQ_DETECTED       POWER_RESETREAS_SREQ_Detected
#define POWER_RESETREAS_LOCKUP_DETECTED     POWER_RESETREAS_LOCKUP_Detected
#define POWER_RESETREAS_OFF_DETECTED        POWER_RESETREAS_OFF_Detected
#define POWER_RESETREAS_LPCOMP_DETECTED     POWER_RESETREAS_LPCOMP_Detected
#define POWER_RESETREAS_DIF_DETECTED        POWER_RESETREAS_DIF_Detected
#define POWER_RESETREAS_NFC_DETECTED        POWER_RESETREAS_NFC_Detected
